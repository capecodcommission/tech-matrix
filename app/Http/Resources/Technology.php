   ...
   public function toArray($request)
    {
        ...
        return [
			...
			'treatment_type' => $this->treatment_type->treatment_type,
			...
			'system_design_considerations' => (is_null($this->system_design_considerations) ? 'N/A' : $this->system_design_considerations),
			'considerations' => (is_null($this->considerations) ? 'N/A' : $this->considerations),
