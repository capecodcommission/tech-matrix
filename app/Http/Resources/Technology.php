   ...
   public function toArray($request)
    {
        return [
			...
			'years_of_evaluation_monitoring' => $this->years_of_evaluation_monitoring->length_of_time,
			'longterm_monitoring_cost' => $this->longterm_monitoring_cost->est_annual_cost,
